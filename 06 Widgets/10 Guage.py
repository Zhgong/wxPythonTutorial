...
class Example(wx.Frame):
    ...
    def InitUI(self):
        ...
        # only to check interval
        self.sInterval = wx.StaticText(pnl)
        vbox.Add(self.sInterval, proportion=1, flag=wx.ALIGN_CENTER)
    ...
    def OnTimer(self, e):
        ...
        self.sInterval.SetLabel(str(self.timer.GetInterval()))
